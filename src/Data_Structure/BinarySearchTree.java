...
//                    space complexity: O(n)
    ...
    public void displayHelper(Node4 root){
    ...
    private int successor(Node4 root){//find least value below the right child of this root node
        root = root.right;
    ...
    private int predecessor(Node4 root){//find greatest value below the right child of this root node
        root = root.left;
